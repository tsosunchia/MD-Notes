...
- [引言](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#引言)
- 前提和设计目标
  - [硬件错误](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#硬件错误)
  - [流式数据访问](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#流式数据访问)
  - [大规模数据集](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#大规模数据集)
  - [简单的一致性模型](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#简单的一致性模型)
  - [“移动计算比移动数据更划算”](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#“移动计算比移动数据更划算”)
  - [异构软硬件平台间的可移植性](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#异构软硬件平台间的可移植性)
- [Namenode 和 Datanode](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#Namenode+和+Datanode)
- [文件系统的名字空间 (namespace)](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#文件系统的名字空间+(namespace))
- 数据复制
  - [副本存放: 最最开始的一步](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#副本存放%3A+最最开始的一步)
  - [副本选择](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#副本选择)
  - [安全模式](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#安全模式)
- [文件系统元数据的持久化](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#文件系统元数据的持久化)
- [通讯协议](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#通讯协议)
- 健壮性
  - [磁盘数据错误，心跳检测和重新复制](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#磁盘数据错误，心跳检测和重新复制)
  - [集群均衡](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#集群均衡)
  - [数据完整性](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#数据完整性)
  - [元数据磁盘错误](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#元数据磁盘错误)
  - [快照](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#快照)
- 数据组织
  - [数据块](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#数据块)
  - [Staging](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#Staging)
  - [流水线复制](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#流水线复制)
- 可访问性
  - [DFSShell](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#DFSShell)
  - [DFSAdmin](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#DFSAdmin)
  - [浏览器接口](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#浏览器接口)
- 存储空间回收
  - [文件的删除和恢复](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#文件的删除和恢复)
  - [减少副本系数](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#减少副本系数)
- [参考资料](https://hadoop.apache.org/docs/r1.0.4/cn/hdfs_design.html#参考资料)
...
在大多数情况下，副本系数是3，HDFS的存放策略是将**一个副本存放在本地机架的节点上，一个副本放在同一机架的另一个节点上，最后一个副本放在不同机架的节点上**。这种策略减少了机架间的数据传输，这就提高了写操作的效率。机架的错误远远比节点的错误少，所以这个策略不会影响到数据的可靠性和可用性。于此同时，因为数据块只放在两个（不是三个）不同的机架上，所以此策略减少了读取数据时需要的网络传输总带宽。在这种策略下，副本并不是均匀分布在不同的机架上。三分之一的副本在一个节点上，三分之二的副本在一个机架上，其他副本均匀分布在剩下的机架中，这一策略在不损害数据可靠性和读取性能的情况下改进了写的性能。
